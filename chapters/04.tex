\chapter{Schematy bloków systemu}
\label{ch:04}
...
\section{Płyta główna SWIM}
  ...
  \begin{figure}[H]
    ...
    \caption{Schemat płyty głównej z mikrokontrolerem \textit{ESP32-S3}. Źródło: opracowanie własne.}
    \label{fig:plyta-glowna}
  \end{figure}

\section{Wyświetlacz siedmiosegmentowy trzycyfrowy}
\label{sec:trzyseg-wysw}
  Na rysunku (Rys. \ref{fig:trzyseg-wysw}) przedstawiono schemat wyświetlacza trzycyfrowego skonstruowanego z 
  połączonych ze sobą w linii ciągłej diod LED.

  \begin{figure}[H]
    \centering
    \includegraphics[angle=90, width=0.9\textwidth]{./graf/trzyseg-wysw.pdf}
    \caption{Wyświetlacz siedmiosegmentowy trzycyfrowy. Źródło: opracowanie własne.}
    \label{fig:trzyseg-wysw}
  \end{figure}

\clearpage
\section{Wyświetlacz siedmiosegmentowy dwucyfrowy}
\label{sec:dwuseg-wysw}
  ...
  \begin{figure}[H]
    ...
    \caption{Wyświetlacz siedmiosegmentowy dwucyfrowy. Źródło: opracowanie własne.}
