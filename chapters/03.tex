...
\label{sec:esp32}
  ...
  na wiele portów wejścia/wyjścia należało wybrać system mikrokontrolerowy zapewniający poniższe możliwości:
  \begin{itemize}
...
\label{sec:przyciski}
  ...
  \textit{COM} co cykl mikrokontrolera pozwala na odczyt aktualnego stanu przycisków. Z uwagi na niską cenę oraz niewielki wymiar 
...
\section{Strona internetowa}
  Bieżąca praca dyplomowa wykorzystuje wykonaną na potrzeby projektu PBL, którego SWIM również był częścią, stronę 
...
\section{Interfejs komunikacyjny}
  Niezbędnym elementem bieżącego projektu jest możliwość komunikacji pomiędzy mikrokontrolerem, a serwowaną na nim stroną w czasie rzeczywistym.
