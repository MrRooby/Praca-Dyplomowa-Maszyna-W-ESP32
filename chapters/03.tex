...
\label{sec:esp32}
  ...
  Własności wybranego układu zapożyczone z dokumentacji firmy \textit{Espressif Systems} \cite{bib:esp-doku}:
  \begin{itemize}
...
\label{sec:serwer}
  ...
  internetowej nie jest częścią poniższej pracy dyplomowej. 
  Zadaniem SWIM jest udostępnianie ww. strony internetowej na lokalnej sieci utworzonej przez mikroprocesor.


  Mikroprocesor wybrany w rozdziale \ref{sec:esp32} umożliwia udostępnianie złożonych stron internetowych z poziomu urządzenia.
...
\section{Zasilanie}
  ...
  \begin{itemize}
    \item dla linii diod LED WS2815B-V1, przy założeniu pełnej jasności każdej z trzech diod RGB oraz wykorzystaniu 600 elementów, przewidziano maksymalny pobór prądu na poziomie około 9~A,
