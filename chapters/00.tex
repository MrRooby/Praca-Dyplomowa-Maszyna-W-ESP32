...
\subsubsection*{Streszczenie}  
  ...
  internetowego symulatora Maszyny W. Urządzenie oparte na mikrokontrolerze \textit{ESP32} komunikuje się ze stroną poprzez 
...
\begin{otherlanguage}{british}
  ...
  system for the Maszyna W web-based simulator. Based on the \textit{ESP32} microcontroller, the device utilizes the  \textit{WebSocket} protocol for real-time synchronization with the website. The hardware layer consists of three 
