...
% \Title
{\raggedright \hspace*{0.5cm} \Title \par}
...
{\raggedright \hspace*{0.5cm} \TitleAlt \par}
% \TitleAlt
\end{otherlanguage}
...
\begin{otherlanguage}{british}
  ...
  system for the Maszyna W web-based simulator. Based on the ESP32 microcontroller, the device utilizes the  WebSocket protocol for real-time synchronization with the website. The hardware layer consists of three 
  custom-designed PCBs: a main board and seven-segment display modules in three- and two-digit versions, 
  all employing addressable \textit{WS2815B} LEDs. A control interface with 17 buttons and an encoder 
