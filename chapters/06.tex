...
\label{sec:w-server}
  ...
  Sposób działania pomija szczegóły zwiazane z inicjalizacją poszczególnych komponentów takich jak: tworzenie serwera DNS czy serwowanie strony internetowej.
