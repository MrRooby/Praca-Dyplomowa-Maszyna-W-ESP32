...
\label{sec:w-server}
  ...
  \textit{W\_Server} zajmuje się kreacją oraz zarządzaniem następującymi funkcjami:
  \begin{itemize}
  ...
  NAJPIERW JEST ANIMACJA ŁADOWANIA
  IP SIĘ WYŚWIETLA
  PO POŁĄCZENIU WYSYŁANA JEST POCZĄTKOWA konfiguracja
  JAK COŚ SIĘ ZMIENI NA STRONIE TO WYSYŁANY JEST DANY ELEMENT
  PRZY ZMIANIE KOLORÓW WYSYŁANA JEST CAŁA STRONA

  Na szczególną uwagę zasługuje ostatni podpunkt. Przy każdorazowej aktualizacji wartości elementów symulatora strona 
  internetowa wysyła wiadomość do urządzenia. 
