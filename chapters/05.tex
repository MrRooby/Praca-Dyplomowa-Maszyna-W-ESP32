...
\section{Opis złącz}
  \subsection{Płyta główna}
    ...
    \subsubsection{Złącze USB-C}
      ...
      płytkę wyposażono w złącze USB typu C (tryb USB 2.0).
    ...
    \subsubsection{Złącze enkodera}
      ...
      \end{itemize}
      Sygnały prowadzone są do wejść cyfrowych mikroprocesora. Redukcję drgań styków 
    ...
    \subsubsection{Złącza przycisków}
      ...
      Jedno wyprowadzenie każdego złącza podłączone jest do masy \textit{GND}, drugie \textemdash{} do wejścia cyfrowego mikroprocesora.
    ...
    \subsubsection{Złącze przełącznika trybów}
      ...
      Jedno wyprowadzenie złącza podłączone jest do masy \textit{GND}, drugie \textemdash{} do wejścia cyfrowego mikroprocesora 
